...
class TenantCreateTest(test.APITransactionTestCase, BaseTenantActionsTest):
    ...
    def create_tenant_request(self, user, payload):
        """Helper method to create tenant using marketplace viewset"""
    ...
    def create_tenant(self, payload):
        ...
        return self.create_tenant_request(self.fixture.staff, payload)
...
class TenantDeleteTest(BaseTenantActionsTest):
    def delete_tenant(self, user):
        """Helper method to delete tenant using marketplace viewset"""
        view = marketplace_views.MarketplaceTenantViewSet.as_view({"delete": "destroy"})
        return common_utils.delete_request(view, user, uuid=self.tenant.uuid.hex)
    ...
    def test_can_delete_tenant_from_private_settings(self, user, mocked_task):
        ...
        response = self.delete_tenant(getattr(self.fixture, user))
    ...
    def test_manager_can_delete_tenant_from_shared_settings_with_permission_from_settings(
        ...
        # Act
        response = self.delete_tenant(self.fixture.manager)
    ...
    def test_admin_can_delete_tenant_from_shared_settings_with_permission_from_settings(
        ...
        # Act
        response = self.delete_tenant(self.fixture.admin)
    ...
    def test_user_can_delete_tenant_if_project_has_been_soft_deleted(self, mocked_task):
        ...
        response = self.delete_tenant(self.fixture.owner)
...
class TenantDisabledActionsTest(test.APITestCase):
    ...
    def test_tenant_create_action_is_not_allowed(self):
        url = factories.TenantFactory.get_list_url()
        data = {
            "name": "Test tenant",
            "service_settings": factories.SettingsFactory.get_url(
                self.fixture.settings
    ...
    def test_tenant_destroy_action_is_not_allowed(self):
        url = factories.TenantFactory.get_url(self.fixture.tenant)
