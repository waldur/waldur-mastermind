...
class BackupScheduleTaskTest(TestCase):
    ...
    @mock.patch("waldur_openstack.handlers.event_logger")
    def test_if_quota_is_exceeded_backup_is_not_created_and_schedule_is_paused(
        ...
        self.instance.tenant.set_quota_limit("snapshots", 2)
        self.instance.tenant.set_quota_usage("snapshots", 2)
...
class SnapshotScheduleTaskTest(TestCase):
    ...
    def test_if_quota_is_exceeded_snapshot_is_not_created_and_schedule_is_paused(
        ...
        # Usage is equal to limit
        schedule.source_volume.tenant.set_quota_limit("snapshots", 2)
        schedule.source_volume.tenant.set_quota_usage("snapshots", 2)
