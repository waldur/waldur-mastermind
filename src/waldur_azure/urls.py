...
def register_in(router):
    ...
    router.register(
        r'azure-locations', views.LocationViewSet, basename='azure-location'
    )
    router.register(
        r'azure-resource-groups',
        views.ResourceGroupViewSet,
        basename='azure-resource-group',
    )
    router.register(
        r'azure-virtualmachines',
        views.VirtualMachineViewSet,
        basename='azure-virtualmachine',
    )
    router.register(
