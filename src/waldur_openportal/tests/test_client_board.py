...
from waldur_openportal import op
...
class OpenPortalRunnerTest(TestCase):
    @mock.patch("waldur_openportal.op.ensure_config_loaded")
    ...
    @mock.patch("waldur_openportal.op.is_config_available")
    def test_health_raises_error_when_config_unavailable(self, mock_config_available):
        mock_config_available.return_value = False

        with mock.patch("waldur_openportal.op.ensure_config_loaded", return_value=True):
            runner = OpenPortalRunner()
    ...
    @mock.patch("waldur_openportal.op.is_config_available")
    @mock.patch("waldur_openportal.op.health")
    ...
    @mock.patch("waldur_openportal.op.is_config_available")
    @mock.patch("waldur_openportal.op.get")
    ...
    @mock.patch("waldur_openportal.op.is_config_available")
    @mock.patch("waldur_openportal.op.run")
...
class OpenPortalBoardTest(TestCase):
    ...
    @mock.patch("waldur_openportal.op.is_config_available")
    @mock.patch("waldur_openportal.op.fetch_job")
