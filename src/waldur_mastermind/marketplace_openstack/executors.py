import waldur_mastermind.marketplace_openstack.tasks
from waldur_core.core import executors as core_executors
from waldur_core.core import tasks as core_tasks
from waldur_core.core import utils as core_utils
from waldur_core.structure import executors as structure_executors
from waldur_mastermind.marketplace_openstack.serializers import _get_template_quotas
...
class OpenStackPackageCreateExecutor(core_executors.BaseExecutor):
    ...
    def get_task_signature(cls, package, serialized_package, **kwargs):
        ...
        populate_service_settings = waldur_mastermind.marketplace_openstack.tasks.OpenStackPackageSettingsPopulationTask().si(
            serialized_package
        )
    ...
    def get_failure_signature(cls, package, serialized_package, **kwargs):
        return waldur_mastermind.marketplace_openstack.tasks.OpenStackPackageErrorTask().s(
            serialized_package
        )
...
class OpenStackPackageChangeExecutor(core_executors.BaseExecutor):
    ...
    def get_task_signature(
        ...
        **kwargs
        ...
        success_package_change = waldur_mastermind.marketplace_openstack.tasks.OpenStackPackageSuccessTask().si(
            serialized_tenant,
