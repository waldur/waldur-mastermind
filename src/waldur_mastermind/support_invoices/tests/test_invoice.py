...
@freeze_time('2018-01-01 00:00:00')
class InvoicesBasicTest(test.APITransactionTestCase):
    def setUp(self):
        super(InvoicesBasicTest, self).setUp()

        support_backend = 'waldur_mastermind.support.backend.basic:BasicBackend'
    ...
    def test_create_invoice(self):
        ...
        self.order_item.order.approve()
        self.order_item.order.save()

        self.order_item.resource.scope.state = support_models.Offering.States.OK
        self.order_item.resource.scope.save()
