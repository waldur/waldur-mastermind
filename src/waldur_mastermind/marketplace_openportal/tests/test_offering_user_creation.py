"""OpenPortal association creates an offering account, backed when the provider owns it.
...
from waldur_mastermind.marketplace_openportal import handlers


class OpenPortalOfferingUserCreationTest(test.APITestCase):
    def setUp(self):
