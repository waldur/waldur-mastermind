...
class ProposalComplianceTestMixin:
    ...
    def setUp(self):
        ...
        if not hasattr(self.fixture.proposal, "checklist_completion"):
            proposal_models.ProposalChecklistCompletion.objects.create(
                proposal=self.fixture.proposal, checklist=self.compliance_checklist
            )
...
class ProposalComplianceCreationTest(
    ...
    def test_checklist_completion_created_on_proposal_creation(self):
        ...
        self.assertTrue(hasattr(new_proposal, "checklist_completion"))
    ...
    def test_no_checklist_completion_without_compliance_checklist(self):
        ...
        self.assertFalse(hasattr(proposal, "checklist_completion"))
    ...
    def test_existing_proposal_completion_status(self):
        ...
        self.assertTrue(hasattr(self.fixture.proposal, "checklist_completion"))
...
class CallManagerComplianceTest(
    ...
    def _submit_test_answers(self):
        ...
        completion = self.fixture.proposal.checklist_completion
        proposal_models.ProposalChecklistAnswer.objects.create(
...
class ChecklistCompletionMixinTest(
    ProposalComplianceTestMixin, test.APITransactionTestCase
):
    """Test the ChecklistCompletionMixin functionality."""
...
class ProposalComplianceSignalsTest(
    ...
    def test_checklist_completion_created_via_signal(self):
        ...
        with self.assertRaises(
            proposal_models.ProposalChecklistCompletion.DoesNotExist
        ):
            proposal.checklist_completion
        ...
        self.assertTrue(hasattr(proposal, "checklist_completion"))
