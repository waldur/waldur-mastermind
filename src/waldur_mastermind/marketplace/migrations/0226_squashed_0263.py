...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            code=_original(
                "0246_plancomponent_discount_aggregation"
        ...
        waldur_core.core.migration_operations.FlushDeferredSql(),
        migrations.RunPython(
            code=_original("_posix_pool_backfill").backfill_posix_pools,
            reverse_code=migrations.RunPython.noop,
        ),
        waldur_core.core.migration_operations.FlushDeferredSql(),
        migrations.RunPython(
        ...
        migrations.AddField(
            model_name="resourceaccesssubnet",
            name="resource",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
        ...
        waldur_core.core.migration_operations.FlushDeferredSql(),
        migrations.RunPython(
            code=_original("_backfill_offering_qos").backfill_qos,
            reverse_code=migrations.RunPython.noop,
        ),
        waldur_core.core.migration_operations.FlushDeferredSql(),
        migrations.RunSQL(
        ...
        waldur_core.core.migration_operations.FlushDeferredSql(),
        migrations.RunPython(
            code=_original("0255_null_stale_scope_content_types").null_stale_scopes,
            reverse_code=migrations.RunPython.noop,
        ),
        waldur_core.core.migration_operations.FlushDeferredSql(),
        migrations.RunPython(
