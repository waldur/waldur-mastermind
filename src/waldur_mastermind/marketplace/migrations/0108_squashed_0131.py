...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        waldur_core.core.migration_operations.FlushDeferredSql(),
        migrations.RunPython(
            code=_original("0121_clean_invalid_usage").clean_componentusage,
        ),
        waldur_core.core.migration_operations.FlushDeferredSql(),
        migrations.RunPython(
            code=_original("0122_add_missing_plan_periods").add_missing_plan_periods,
        ),
        waldur_core.core.migration_operations.FlushDeferredSql(),
        migrations.RunPython(
            code=_original("0123_drop_druplicate_usage").drop_druplicate_usage,
        ),
        waldur_core.core.migration_operations.FlushDeferredSql(),
        migrations.RunPython(
            code=_original(
