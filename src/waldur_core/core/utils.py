...
def format_time_and_value_to_segment_list(
    time_and_value_list, segments_count, start_timestamp, end_timestamp, average=False
):
    """
    ...
    for i in range(segments_count):
        ...
        value_list = [
            value
            for time, value in time_and_value_list
