...
class TestServiceSerializer(structure_serializers.ServiceOptionsSerializer):
    ...
    backend_url = serializers.CharField(max_length=200,)
    ...
    tenant_name = serializers.CharField(
        source='options.tenant_name', default='admin', required=False,
    )

    availability_zone = serializers.CharField(
        source='options.availability_zone', required=False,
    )
