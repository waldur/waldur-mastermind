    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to='waldur_rijkscloud.FloatingIP',
            ),
        ),
        migrations.AddField(
            model_name='instance',
            ...
            field=models.ForeignKey(
                default=None,
                on_delete=django.db.models.deletion.CASCADE,
                to='waldur_rijkscloud.InternalIP',
            ),
        ...
        migrations.AlterUniqueTogether(
            name='internalip', unique_together=set([('settings', 'backend_id')]),
        ),
        migrations.AlterUniqueTogether(
            name='floatingip', unique_together=set([('settings', 'backend_id')]),
        ),
    ]
