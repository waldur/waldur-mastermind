...
project = 'Waldur MasterMind'
copyright = '2016, OpenNode'
...
htmlhelp_basename = 'waldur-mastermind'
...
latex_documents = [
  ('index', 'waldur-mastermind.tex', 'Waldur MasterMind Documentation',
   'OpenNode', 'manual'),
]
...
man_pages = [
    ('index', 'waldur-mastermind', 'Waldur MasterMind Documentation',
     ['OpenNode'], 1)
]
...
texinfo_documents = [
  ('index', 'Waldur MasterMind ', 'Waldur MasterMind Documentation',
   'OpenNode', 'waldur-mastermind', 'One line description of project.',
   'Miscellaneous'),
]
