...
class OrderItemCreateTest(unittest.TestCase):
    ...
    def test_create_marketplace_order_item(self, mock_ansible_module, mock_waldur_client):
        client = mock.Mock()
        client.create_marketplace_order.return_value = {'items': [{'uuid': 'order_item_uuid'}]}
    ...
    def test_fail_json_is_called_if_file_is_not_found(self, mock_ansible_module, mock_waldur_client):
    ...
    def test_exit_json_is_called_if_file_is_found(self, mock_ansible_module, mock_waldur_client):
