...
Requires: ansible-waldur-module >= 0.6.0
Requires: waldur-core >= 0.157.0
Requires: waldur-ansible >= 0.5.0
...
Requires: waldur-jira >= 0.7.0
Requires: waldur-openstack >= 0.41.0
